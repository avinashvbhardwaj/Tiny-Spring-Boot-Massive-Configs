...
//            updateTheStudent(studentDAO);
    ...
    private void updateTheStudent(StudentDAO studentDAO) {
        ...
        // change lastName to Bhardwaj
        theStudent.setLastName("Sharma");

        //update th student
        studentDAO.update(theStudent);

        //display the updated Student
        Student updatedStudent = studentDAO.findById(2);
        System.out.println("displaying student " + updatedStudent);
    }

    private void deleteTheStudent(StudentDAO studentDAO) {
        System.out.println("Going to delete the student 5");
